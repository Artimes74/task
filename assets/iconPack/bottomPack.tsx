...
export const HomeIcon = (width: number, height: number, color: string) => (
    <Svg width={width} height={height} viewBox="0 0 25 24" fill="none">
        ...
        <Path
            ...
            fill="#0A8080" stroke="#FAFAFA" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <Path d="M12.5 17.99V14.99" stroke="#FAFAFA" stroke-width="1.5" stroke-linecap="round"
...
export const AddIcon = (width: number, height: number, color: string) => {
    return (
        <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
            <Path d="M6 12H18" stroke="#71717A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <Path d="M12 18V6" stroke="#71717A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </Svg>
